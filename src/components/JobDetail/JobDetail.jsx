...
import { CalendarDaysIcon, CurrencyDollarIcon, DocumentMagnifyingGlassIcon, EnvelopeIcon, MapPinIcon, PhoneIcon } from '@heroicons/react/24/solid'

const JobDetail = ({ job }) => {
    console.log(job);
    const { jobDescription, jobResponsibility, educationalRequirements, experiences, salary, location, jobTitle, contactInformation } = job;
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-2'>
            ...
            <div className='lg:col-span-1 bg-[#f5f1ff] rounded p-7'>
